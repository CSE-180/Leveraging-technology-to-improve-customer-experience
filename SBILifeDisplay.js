...
export default function RelianceDisplay() {
    const pdfUrl = 'https://smartcare.sbilife.co.in/SmartCare/assets/policy-holder-guides/Life%20insurance%20booklet_5x8_Web_Compressed_25102019.pdf';
    ...
    return (
        <div>
            <a
    href="https://drive.google.com/file/d/1Kkz5XHsI5CGZgGK-BW---7fEX21GUgBI/view" // Direct download link
    download="sbilife.pdf" // Desired file name for the download
    style={buttonStyle}
>
    Download PDF
</a>
