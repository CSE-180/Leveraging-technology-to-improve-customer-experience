...
export default function RelianceDisplay() {
    ...
    const handleRedirect = () => {
        window.location.href = 'https://www.reliancegeneral.co.in'; // Replace with the target company page URL
    };

    // Move buttonStyle definition above usage
    const buttonStyle = {
        padding: '10px 20px',
    ...
    return (
        <div>
            <a
    href="https://drive.google.com/file/d/1LE0FK3YVxl5Il90J_D5eAw02QB9X4qtk/view" // Direct download link
    download="reliance-global-health-policy.pdf" // Desired file name for the download
    style={buttonStyle}
>
    Download PDF
</a>
            <h1>Reliance General</h1>
